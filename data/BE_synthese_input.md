...
- Variation jour : +2,53 %
- Volume jour : 9,5 M
- Capitalisation : 82,64 MdUSD
- Nombre d'actions : 284,4 M
- Plus-haut 52 semaines : 296,50 USD
- Plus-bas 52 semaines : 16,05 USD
- Position dans range 52s : 97,9 %

## 2. Indicateurs techniques

- RSI(14) : 77,9 (zone surachat)
- MACD : +31,4463 (signal haussier)
- MA50 : 175,50 USD
- MA200 : 114,38 USD
- Cours vs MA50 : +65,54 %
- Cours vs MA200 : +153,99 %

## 3. Niveaux Fibonacci (range 52s)

| Niveau | Prix | Δ vs cours | Statut |
|---|---|---|---|
| 0,0 % | 16,05 USD | -94,48 % | Support |
| 23,6 % | 82,24 USD | -71,69 % | Support |
| 38,2 % | 123,18 USD | -57,60 % | Support |
| 50,0 % | 156,28 USD | -46,21 % | Support |
| 61,8 % | 189,37 USD | -34,82 % | Support |
| 100,0 % | 296,50 USD | +2,06 % | Cours actuel |

## 4. Variations historiques

- Variation 1 jour : +2,53 %
- Variation 7 jours : +25,67 %
- Variation 30 jours : +114,20 %
- Variation 90 jours : +91,93 %
- Variation 1 an : +1667,15 %

## 5. Métadonnées société (depuis YAML éditorial)

- Nom : Bloom Energy
- ISIN : US0937121079
- Marché : NYSE (États-Unis)
- Secteur : Cleantech — Solid Oxide Fuel Cells
- PEA-PME : non éligible
- Liens IR : https://investor.bloomenergy.com/

## 6. Contexte éditorial actuel (depuis YAML éditorial)

### Alertes & catalyseurs documentés

**[MOAT] Technologie SOFC haute température — différenciation vs PEM/MCFC**
...
**[CATALYSEUR] Deal AEP — 2,65 Md$ pour 1 GW de SOFC (janvier 2026)**
...
- Publication 10-Q Q1 2026 sur SEC EDGAR (Q1 publié 28/04/2026)
...
- Texte de synthèse précédent :
  > Bloom Energy a publié le 28 avril 2026 un Q1 2026 record :
  > revenus 751,1 M$ (+130,4 % YoY), EPS 0,44 $ (vs consensus 0,13 $),
  > marge opérationnelle non-GAAP 17,3 %. La guidance FY2026 a été
  > relevée à 3,4-3,8 Md$ (mid 3,6 Md$, ~+80 % YoY). Le backlog au
  > 31/12/2025 atteint ~6 Md$ produit (+140 % YoY) et ~14 Md$ service.
  >
  > Le pipeline commercial est dominé par trois deals structurants :
  > Oracle 2,8 GW (extension du master services agreement, 14/04/2026,
  > avec warrant 400 M$) et Project Jupiter 2,45 GW (27/04/2026) ;
  > AEP 2,65 Md$ pour 1 GW (janvier 2026), avec AWS et Cologix derrière
  > via AEP Ohio approuvé par la PUCO en juin 2025 ; Brookfield
  > « 5 Md$ on-site power partner » sur le portefeuille infrastructure.
  > La cible de capacité production est de 2 GW/an d'ici fin 2026 (vs
  > ~1 GW), avec une vision long terme de 5 GW/an.
  >
  > Le profil de risque est dominé par la valorisation : cours 283 $
  > au 01/05/2026, capitalisation ~80,6 Md$, +134 % YTD, ratio implicite
  > ~22x mid-guidance FY2026. La concentration client (Oracle / AEP /
  > Brookfield) et la dilution potentielle du warrant Oracle 400 M$
...
- Facteurs positifs précédents :
  ...
  - Backlog produit ~6 Md$ (+140 % YoY) + service ~14 Md$ (visibilité multi-années)
  - Doublement capacité production à 2 GW/an d'ici fin 2026 (vs ~1 GW actuel)
  - Marge brute GAAP 29 % FY2025 (+1,6 pp YoY), trajectoire vers ~32 % non-GAAP
- Facteurs négatifs précédents :
  - Capitalisation ~80,6 Md$ au 01/05/2026 — ratio implicite ~22x revenus FY2026E
  - Variation +134 % YTD 2026 — risque de correction sur tout repli du narratif IA
  - Concentration client (Oracle/AEP/Brookfield dominent le backlog)
  - Warrant Oracle 400 M$ — dilution potentielle structurelle
  - Crédit 45V raboté par la One Big Beautiful Bill Act (04/07/2025) — branche SOEC exposée

## 8. Garde-fous d'audit pour BE
...
- Deal Oracle au 27/04/2026 = **2,8 GW total** (1,2 GW déjà sous contrat) + **Project Jupiter 2,45 GW** (BorderPlex, New Mexico) + **warrant Oracle 400 M$** sur le stock BE (émis 09/04/2026, termes annoncés 30/10/2025).
- Deal AEP janvier 2026 = **2,65 Md$ pour 1 GW de SOFC** (~20 ans d'offtake). Premier déploiement Ohio : site Hilliard 72,9 MW (PUCO 28/05/2025) — AWS contrat 6 ans, Cologix contrat 15 ans.
- Crédit hydrogène 45V **raboté** par la One Big Beautiful Bill Act signée par Donald Trump le **04/07/2025** (construction obligatoire avant 31/12/2027). Le 45V reste **exempté des restrictions FEoC** (Baker Botts, K&L Gates). Le crédit ITC § 48E pour fuel cells reste préservé à 30 % jusqu'à phase-out à partir de 2034.
- Q1 2026 publié **28/04/2026** : revenus **751,1 M$ (+130,4 % YoY)**, **EPS GAAP dilué 0,23 $** (vs perte 0,10 $) et **EPS non-GAAP 0,44 $**. Marge brute Q1 GAAP 30,0 %, non-GAAP 31,5 %. Guidance FY2026 relevée à **3,4-3,8 Md$** (mid 3,6 Md$).
- Cours **283,36 $ / capi ~80,6 Md$ au 01/05/2026, +134 % YTD 2026** ; ratio implicite **~22x mid-guidance FY2026** (calcul transparent capi/guidance).
- **Cummins/Accelera NON concurrent SOFC stationnaire data centers** au 02/05/2026 (revue stratégique nov 2025 + charge non-cash 240 M$ + cession activité fuel cell rail à Alstom avril 2026). Toute mention future de Cummins comme concurrent SOFC data centers doit être corroborée par un communiqué primaire 2026+.
- **CFO Simon Edwards effectif 13/04/2026** (ex-Groq, en remplacement de Daniel Berenbaum). KR Sridhar reste fondateur, président du conseil et CEO depuis 2001.
